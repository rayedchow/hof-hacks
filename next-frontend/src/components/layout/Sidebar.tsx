  ...
  return (
    <Link
      ...
      className={`flex items-center px-4 py-3 mb-1 rounded-md automate-transition
         ${
           isActive
             ? "bg-automate-purple text-white"
             : "text-gray-300 hover:bg-automate-dark-gray"
         }`}
      onClick={onClick}
    >
...
const Sidebar = ({ collapsed, toggleCollapse }: SidebarProps) => {
  return (
    <div
      className={`${
        collapsed ? "w-16" : "w-64"
      } bg-automate-black border-r border-gray-800 flex flex-col automate-transition`}
    >
      <div className="p-4 flex items-center">
        {!collapsed ? (
          <div className="flex items-center">
            ...
            <h1 className="ml-2 font-bold text-xl automate-gradient-text">
              {" "}
              Algora{" "}
            </h1>
          </div>
